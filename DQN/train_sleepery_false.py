...
# Hyperparameters for slippery=False (more aggressive)
learning_rate = 0.002  # Higher learning rate for deterministic env
discount_factor = 0.85  # Lower discount factor for shorter episodes
network_sync_rate = 300  # Sync more frequently
replay_memory_size = 8000  # Smaller memory
mini_batch_size = 64  # Smaller batch size
epsilon_start = 1.0
epsilon_min = 0.01
epsilon_decay = 0.9998  # Faster epsilon decay
episodes = 3000  # Fewer episodes needed
hidden_nodes = 128
...
env.close()
torch.save(policy_net.state_dict(), "frozenlake_slippery_false.pt")
...
plt.savefig('training_slippery_false.png')